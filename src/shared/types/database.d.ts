...
export type CreateSuggestionInput = Omit<Suggestion, 'id' | 'created_at' | 'applied_at' | 'action_type' | 'target_clip_id' | 'action_payload_json' | 'preview_snapshot_json' | 'clip_id'> & {
