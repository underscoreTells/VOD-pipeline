export type AgentInputMessage = ChatInputMessage | AnalyzeChaptersInputMessage | StopInputMessage;
export type AgentInputMessageWithId = AgentInputMessage;
export type AgentInputMessageWithoutId = ChatInputMessageWithoutId | AnalyzeChaptersInputMessageWithoutId | StopInputMessageWithoutId;
...
export type AgentOutputMessage = ReadyOutputMessage | ProgressOutputMessage | TokenOutputMessage | GraphCompleteOutputMessage | ErrorOutputMessage;
